...
public class MainActivity extends AppCompatActivity {
    ...
    public void click(View view) {
        ...
        switch (view.getId()) {
            case R.id.tourist: {
//                YaowanSDK.getInstance().register(MainActivity.this, "test", "123456", new CSJCallBackListener.OnRegProcessListener() {
//                    @Override
//                    public void onRegSuccess(YWUser user) {
//
//                    }
//
//                    @Override
...
//                YaowanSDK.getInstance().loginTourist(MainActivity.this, new CSJCallBackListener.OnLoginProcessListener() {
//                    @Override
//                    public void onLoginSuccess(YWUser user) {
//                        showToast("登录成功："+user.getAccountId());
//
//                    }
//
//                    @Override
...
//                YaowanSDK.getInstance().bindPhone(MainActivity.this, "13450203360", "654321", "525860", new CSJCallBackListener.OnCallbackListener() {
//                    @Override
//                    public void callback(int code) {
//                        switch (code) {
//                            case CSJReturnCode.SUCCESS:
...
//                });
            ...
            case R.id.weixin_login: {
                ChuanshanjiaSDK.getInstance().loginWithWeixin(MainActivity.this, new CSJCallBackListener.OnLoginProcessListener() {
            ...
            case R.id.wb_login_btn: {
                ChuanshanjiaSDK.getInstance().loginWithWB(MainActivity.this, new CSJCallBackListener.OnLoginProcessListener() {
            ...
            case R.id.qq_login: {
                if (ChuanshanjiaSDK.getInstance().isQQAppInstalled()) {
                    Log.i("qq_login:", "Installed");
                } else {
                    Log.i("qq_login:", "Not Installed");
                }
                ChuanshanjiaSDK.getInstance().loginWithQQ(MainActivity.this, new CSJCallBackListener.OnLoginProcessListener() {
...
//                YaowanSDK.getInstance().submitRealname(MainActivity.this, "习大大", "441521198503137711", new CSJCallBackListener.OnCallbackListener() {
//                    @Override
//                    public void callback(int code) {
//
//                        switch (code) {
...
//
//                                break;
//                            case CSJReturnCode.REALNAME_ERROR:
//                                showToast("姓名有误");
//                                break;
//                            case CSJReturnCode.SFZ_ERROR:
//                                showToast("身份证有误");
//                                break;
//                            default:
//                                showToast("认证失败：" + code);
...
//            case R.id.yeepay: {
//                YaowanSDK.getInstance().payWithYeepay(MainActivity.this, "0.01", "123456758", "", "金币", "http://yaowan.com", new CSJCallBackListener.OnPayProcessListener() {
//                    @Override
...
//                YaowanSDK.getInstance().payWithWeixin(MainActivity.this, "0.01", "123456758", "123", "金币", "http://yaowan.com", new CSJCallBackListener.OnPayProcessListener() {
//                    @Override
//                    public void finishPayProcess(int code) {
//
//                        switch (code) {
...
//                                // 充值失败
//                                break;
//                            case CSJReturnCode.WEIXIN_NOT_INSTALLED:
//                                showToast("微信未安装");
//                                break;
//                            default:
//
...
//                YaowanSDK.getInstance().shareToWechat(MainActivity.this, targeturl, imageurl, title, content, new CSJCallBackListener.OnShareListener() {
//                    @Override
//                    public void onSuccess() {
//                        Log.i(TAG, "onSuccess: ");
//                    }
